...
class ModelDecisionMaker:
    def __init__(self):
        ...
        self.kai = pd.read_csv('/mnt/c/Users/Rado/Desktop/Individual Project/SATbot/SATbot/model/kai.csv', encoding='ISO-8859-1') #change path
        self.robert = pd.read_csv('/mnt/c/Users/Rado/Desktop/Individual Project/SATbot/SATbot/model/robert.csv', encoding='ISO-8859-1')
        self.gabrielle = pd.read_csv('/mnt/c/Users/Rado/Desktop/Individual Project/SATbot/SATbot/model/gabrielle.csv', encoding='ISO-8859-1')
        self.arman = pd.read_csv('/mnt/c/Users/Rado/Desktop/Individual Project/SATbot/SATbot/model/arman.csv', encoding='ISO-8859-1')
        self.olivia = pd.read_csv('/mnt/c/Users/Rado/Desktop/Individual Project/SATbot/SATbot/model/olivia.csv', encoding='ISO-8859-1')
        ...
        self.QUESTIONS = {
            ...
            "ask_name": {
               ...
               "choices": {
                   ...
                   #"open_text": lambda user_id, db_session, curr_session, app: self.get_kai(user_id)
               },
               "protocols": {"open_text": []},
           },
        ...
        #   },
            ...
            "guess_emotion": {
                ...
                "choices": {
                    "yes": {
                        ...
                        "Envious": "after_classification_negative",
                        "Jealous": "after_classification_negative"
                    },
                    "no": "check_emotion",
                },
                "protocols": {
            ...
            "check_emotion": {
                ...
                "choices": {
                    ...
                    "Loving/Caring": lambda user_id, db_session, curr_session, app: self.get_loving_emotion(user_id),
                    "Insecure": lambda user_id, db_session, curr_session, app: self.get_insecure_emotion(user_id),
                    "Disgusted": lambda user_id, db_session, curr_session, app: self.get_disgusted_emotion(user_id),
                    "Disappointed": lambda user_id, db_session, curr_session, app: self.get_disappointed_emotion(user_id),
                    "Ashamed": lambda user_id, db_session, curr_session, app: self.get_ashamed_emotion(user_id),
                    "Guilty": lambda user_id, db_session, curr_session, app: self.get_guilty_emotion(user_id),
                    "Envious": lambda user_id, db_session, curr_session, app: self.get_envious_emotion(user_id),
                    "Jealous": lambda user_id, db_session, curr_session, app: self.get_jealous_emotion(user_id),
                },
                "protocols": {
                    "Sad": [],
                    "Angry": [],
            ...
            ############# NEGATIVE EMOTIONS (SADNESS, ANGER, FEAR/ANXIETY, INSECURITY, SHAME, GUILT, ENVY, JEALOUSY)
            ...
            ################# POSITIVE EMOTION (HAPPINESS/CONTENT, LOVING/CARING) #################
    ...
    def determine_next_prompt_opening(self, user_id, app, db_session):
        ...
        if emotion == 'fear':
            ...
            self.guess_emotion_predictions[user_id] = 'Insecure'
            ...
            self.guess_emotion_predictions[user_id] = 'Ashamed'
    ...
    def get_loving_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Loving/Caring"
        self.user_emotions[user_id] = "Loving"
        return "after_classification_positive"
    def get_insecure_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Insecure"
        self.user_emotions[user_id] = "Insecure"
        return "after_classification_negative"
    def get_disgusted_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Disgusted"
        self.user_emotions[user_id] = "Disgusted"
        return "after_classification_negative"
    def get_disappointed_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Disappointed"
        self.user_emotions[user_id] = "Disappointed"
        return "after_classification_negative"
    def get_ashamed_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Ashamed"
        self.user_emotions[user_id] = "Ashamed"
        return "after_classification_negative"
    def get_guilty_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Guilty"
        self.user_emotions[user_id] = "Guilty"
        return "after_classification_negative"
    def get_envious_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Envious"
        self.user_emotions[user_id] = "Envious"
        return "after_classification_negative"
    def get_jealous_emotion(self, user_id):
        self.guess_emotion_predictions[user_id] = "Jealous"
        self.user_emotions[user_id] = "Jealous"
        return "after_classification_negative"
    ...
    def determine_next_choice(
        ...
        if input_type != "open_text":
            ...
            if (
                ...
                if user_choice == "Sad":
                    ...
                    protocols_chosen = current_protocols["Loving/Caring"]
                elif user_choice == "Insecure":
                    next_choice = current_choice_for_question["Insecure"]
                    protocols_chosen = current_protocols["Insecure"]
                elif user_choice == "Disgust":
                    next_choice = current_choice_for_question["Disgusted"]
                    protocols_chosen = current_protocols["Disgusted"]
                elif user_choice == "Disappointed":
                    next_choice = current_choice_for_question["Disappointed"]
                    protocols_chosen = current_protocols["Disappointed"]
                elif user_choice == "Ashamed":
                    next_choice = current_choice_for_question["Ashamed"]
                    protocols_chosen = current_protocols["Ashamed"]
                elif user_choice == "Guilty":
                    next_choice = current_choice_for_question["Guilty"]
                    protocols_chosen = current_protocols["Guilty"]
                elif user_choice == "Envious":
                    next_choice = current_choice_for_question["Envious"]
                    protocols_chosen = current_protocols["Envious"]
                else:
                    next_choice = current_choice_for_question["Jealous"]
                    protocols_chosen = current_protocols["Jealous"]
            else:
        ...
        if current_choice == "guess_emotion" and user_choice.lower() == "yes":
            ...
            elif self.guess_emotion_predictions[user_id] == "Insecure":
            ...
            elif self.guess_emotion_predictions[user_id] == "Ashamed":
